(function (global, factory) {
	...
	(factory((global.abstractedFirebase = {})));
	...
	var rtdb = createCommonjsModule(function (module, exports) {
	...
	var storage_1 = storage.NOT_DONE;

	var firestore = createCommonjsModule(function (module, exports) {
	// export {
	//   DocumentData,
	//   UpdateData,
	//   LogLevel,
	...
	unwrapExports(firestore);

	var messaging = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	// export { FirebaseMessaging } from "@firebase/messaging-types";
	exports.NotYetDone = true;
	});

	unwrapExports(messaging);
	var messaging_1 = messaging.NotYetDone;
	...
	unwrapExports(lib);
	var lib_1 = lib.rtdb;
	var lib_2 = lib.storage;
	var lib_3 = lib.firestore;
	var lib_4 = lib.messaging;
	var lib_5 = lib.app;
	var lib_6 = lib.auth;
	...
	exports.rtdb = lib.rtdb;
	exports.auth = lib.auth;
	});

	var index$1 = unwrapExports(lib$1);
	var lib_1$1 = lib$1.RealTimeDB;
	var lib_2$1 = lib$1.FirebaseBoolean;
	var lib_3$1 = lib$1.rtdb;
	var lib_4$1 = lib$1.auth;

	exports.default = index$1;
	exports.RealTimeDB = lib_1$1;
	exports.FirebaseBoolean = lib_2$1;
	exports.rtdb = lib_3$1;
	exports.auth = lib_4$1;
