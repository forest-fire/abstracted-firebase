(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('common-types'), require('wait-in-parallel'), require('typed-conversions'), require('serialized-query'), require('firebase-api-surface')) :
  typeof define === 'function' && define.amd ? define(['exports', 'common-types', 'wait-in-parallel', 'typed-conversions', 'serialized-query', 'firebase-api-surface'], factory) :
  (factory((global.AbstractedFirebase = {}),global.commonTypes,null,global.convert,global.serializedQuery,global.firebaseApiSurface));
}(this, (function (exports,commonTypes,waitInParallel,convert,serializedQuery,firebaseApiSurface) { 'use strict';
