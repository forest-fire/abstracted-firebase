...
var FirebaseDepthExceeded =
/*#__PURE__*/
function (_Error) {
  function FirebaseDepthExceeded(e) {
    var _this;

    _classCallCheck(this, FirebaseDepthExceeded);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FirebaseDepthExceeded).call(this, e.message));
    _this.stack = e.stack;
  ...
  _inherits(FirebaseDepthExceeded, _Error);

  return FirebaseDepthExceeded;
}(_wrapNativeSuper(Error));

var UndefinedAssignment =
/*#__PURE__*/
function (_Error) {
  function UndefinedAssignment(e) {
    var _this;

    _classCallCheck(this, UndefinedAssignment);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(UndefinedAssignment).call(this, e.message));
    _this.stack = e.stack;
  ...
  _inherits(UndefinedAssignment, _Error);

  return UndefinedAssignment;
}(_wrapNativeSuper(Error));

function slashNotation(path) {
  return path.substr(0, 5) === ".info" ? path.substr(0, 5) + path.substring(5).replace(/\./g, "/") : path.replace(/\./g, "/");
}
...
function () {
  ...
  _createClass(RealTimeDB, [{
    ...
    value: function getSnapshot(path) {
      return __awaiter(this, void 0, void 0, function* () {
        return typeof path === "string" ? this.ref(slashNotation(path)).once("value") : path.setDB(this).execute();
      });
    }
  }, {
    key: "getValue",
